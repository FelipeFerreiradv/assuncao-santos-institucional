...
export function ContactForm() {
  ...
  async function onSubmit(values: ContactValues) {
    ...
    const message = `Olá! Vim pelo site do ${SITE.shortName}. Me chamo ${values.nome}. ${values.mensagem} — Contatos: ${values.telefone} · ${values.email}`;
    const whatsappBase =
      SITE.contact.whatsappUrl.split("?")[0] ?? "https://wa.me/5511925533716";
